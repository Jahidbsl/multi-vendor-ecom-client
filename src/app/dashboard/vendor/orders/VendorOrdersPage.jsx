...
export default function VendorOrdersPage() {
  ...
  const fetchOrders = useCallback(async () => {
    // Don't fetch until we actually know who the vendor is — otherwise
    // this call hits the API with no vendorId and gets back EVERY
    // vendor's orders (same list the admin sees).
    if (!vendorId) {
      setLoading(false);
      return;
    }
  ...
  }, [page, statusFilter, search, vendorId]);
